...
function Benefits() {
  return (
    <section className="max-w-7xl m-auto px-8 sm:px-12 mt-24 space-y-24">
      <BenefitItem
        image="./img/template1/benefit-1.svg"
      ...
      <BenefitItem
        image="../img/template1/benefit-2.svg"
      ...
      <BenefitItem
        image="../img/template1/benefit-3.svg"
