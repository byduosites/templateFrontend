...
function Testimonials() {
  ...
  return (
    <section className="max-w-7xl m-auto px-8 sm:px-12 mt-36 text-center flex flex-col items-center">
      ...
      <div className="mt-12 min-w-[80vw] justify-center md:gap-4 md:min-w-full grid gap-8 md:grid-cols-3">
        <TestimonialItem
          ...
          userImg="../img/template1/user-1.jpg"
          rating={4}
        ...
        <TestimonialItem
          ...
          userImg="../img/template1/user-2.jpg"
          rating={3}
          testimonial={testimonial}
        />
        <TestimonialItem
          ...
          userImg="../img/template1/user-3.jpg"
          rating={4}
          testimonial={testimonial}
        />
      </div>
