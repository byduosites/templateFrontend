export const headerData = {
  logoImg1: "../src/assets/img/header/logoV1.svg",
  logoImgV2: "../src/assets/img/header/logoV2.svg",
  btnText: "Contact us",
};
...
export const heroData = {
  ...
  sceneImg: "../img/template3/hero/scene.svg",
  boyImg: "../img/template3hero/boy.svg",
  girlImg: "../img/template3/hero/girl.svg",
  truckImg: "../img/template3/hero/truck.svg",
  btnText: "Get Started",
};
