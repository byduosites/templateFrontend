...
// import boyImg from "../img/template3/about/boy.svg";
        ...
        >
          <motion.div variants={fadeInDown} className="flex-1 mt-[74px]">
            ...
            <div className="bg-accent/10 border-l-[10px] border-accent  lg:py-10 py-6 flex items-center justify-start mb-8 lg:mb-0 pl-4">
              <p className="text-[20px] leading-normal lg:text-[24px] lg:leading-[32px] bg-red-300 p-3 text-black border-l-4 border-red-400 font-medium  lg:max-w-[460px]">
                {text}
              </p>
            </div>
          </motion.div>
          ...
          >
            <img
              src="../img/template3/about/boy.svg"
              alt="boy"
              className="md:w-[575px] md:h-[400px] w-full"
            />
          </motion.div>
        </motion.div>
      </div>
