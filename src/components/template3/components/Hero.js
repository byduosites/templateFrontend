...
// src = "../img/template3/hero/truck.svg";
    ...
    <section className="bg-hero bg-no-repeat bg-left-top min-h-[800px] lg:min-h-[950px] lg:mb-80">
      ...
      >
        ...
        <motion.button
          ...
          variants={fadeInDown}
          className="btn bg-red-500 text-white px-10 py-2 text-2xl border-none rounded-md"
        >
          {btnText}
        ...
        >
          <img
            src="../img/template3/hero/girl.svg"
            alt="girl"
            className="w-[286px] h-[495px]"
          />
        </motion.div>
        ...
        >
          <img
            src="../img/template3/hero/boy.svg"
            alt="boy"
            className="w-[286px] h-[495px]"
          />
        </motion.div>
